...
namespace WindowsFormsApp1 {
    ...
    public partial class lab2DataSet : global::System.Data.DataSet {
        ...
        public partial class страныDataTable : global::System.Data.TypedTableBase<страныRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public страныRow AddстраныRow(string Страна, string Столица, string Континент, int Население) {
            ...
            public string Континент {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Континент\' в таблице \'страны\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public int Население {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Население\' в таблице \'страны\' равно DBNull.", e);
                    }
                }
                set {
...
namespace WindowsFormsApp1.lab2DataSetTableAdapters {
    ...
    public partial class страныTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `страны` WHERE ((`Код` = ?) AND ((? = 1 AND `Страна` IS NULL) OR (`Страна` = ?)) AND ((? = 1 AND `Столица` IS NULL) OR (`Столица` = ?)) AND ((? = 1 AND `Континент` IS NULL) OR (`Континент` = ?)) AND ((? = 1 AND `Население` IS NULL) OR (`Население` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `страны` (`Страна`, `Столица`, `Континент`, `Население`) VALUES (?, ?" +
                ", ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `страны` SET `Страна` = ?, `Столица` = ?, `Континент` = ?, `Население` = ? WHERE ((`Код` = ?) AND ((? = 1 AND `Страна` IS NULL) OR (`Страна` = ?)) AND ((? = 1 AND `Столица` IS NULL) OR (`Столица` = ?)) AND ((? = 1 AND `Континент` IS NULL) OR (`Континент` = ?)) AND ((? = 1 AND `Население` IS NULL) OR (`Население` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Код, Страна, Столица, Континент, Население FROM страны";
        ...
        public virtual int Fill(lab2DataSet.страныDataTable dataTable) {
        ...
        public virtual lab2DataSet.страныDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            lab2DataSet.страныDataTable dataTable = new lab2DataSet.страныDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(lab2DataSet.страныDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Код, string Original_Страна, string Original_Столица, string Original_Континент, global::System.Nullable<int> Original_Население) {
        ...
        public virtual int Update(string Страна, string Столица, string Континент, global::System.Nullable<int> Население, int Original_Код, string Original_Страна, string Original_Столица, string Original_Континент, global::System.Nullable<int> Original_Население) {
            if ((Страна == null)) {
