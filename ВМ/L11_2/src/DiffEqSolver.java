...
public abstract class DiffEqSolver {
    ...
    /**
     * Constructor.     * @param equation the differential equation to solve
     */
    ...
    /**
     * Return the next data point in the     * approximation of the solution.     * @param h the width of the interval
     */
